...
const ContactRow = ({ name, subtitle, onPress, style, onLongPress, selected, showForwardIcon = true, subtitle2, avatar }) => {
    return (
        <TouchableOpacity style={[styles.row, style]} onPress={onPress} onLongPress={onLongPress}>
            ...
            {showForwardIcon && <Ionicons name="chevron-forward-outline" size={20} color="#fff" />}
